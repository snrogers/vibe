...
export type AppEvent =
  ...
  | INPUT_SUBMITTED
  | KEY_INPUT
  | PLANNING_COMPLETION_CANCEL
  | PLANNING_COMPLETION_FAILURE
  | PLANNING_COMPLETION_STARTED
  | PLANNING_COMPLETION_SUCCESS
  | PROMPT_SUBMITTED
  | SET_INSPECT_MODE
  | TOOLS_COMPLETE
  | TOOL_CONFIRMED
...
export type CHAT_SESSION_LOADED =
  Event<'CHAT_SESSION_LOADED', { chatSession: ChatSession }>
...
export type PLANNING_COMPLETION_CANCEL =
  Event<'PLANNING_COMPLETION_CANCEL'>

export type PLANNING_COMPLETION_FAILURE =
  Event<'PLANNING_COMPLETION_FAILURE', { error: unknown }>

export type PLANNING_COMPLETION_STARTED =
  Event<'PLANNING_COMPLETION_STARTED', { message: string }>

export type PLANNING_COMPLETION_SUCCESS =
  Event<'PLANNING_COMPLETION_SUCCESS', { assistantMessage: AssistantMessage, usage: Usage }>
